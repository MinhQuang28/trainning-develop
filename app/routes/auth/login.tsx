    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center shadow-2xl mb-4">
        ...
        <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-8 shadow-2xl">
          <div className="space-y-5">
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-medium rounded-lg hover:from-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-all shadow-lg"
            >
              Đăng nhập
            </button>
          </div>
          ...
          <div className="space-y-3">
            <button className="w-full py-3 px-4 bg-gray-800 border border-gray-700 text-gray-300 font-medium rounded-lg hover:bg-gray-750 transition-all flex items-center justify-center gap-3">
        ...
        <p className="text-center text-gray-500 text-xs mt-6">
          ...
          <button className="text-purple-400 hover:text-purple-300">Điều khoản dịch vụ</button>
          {" "}và{" "}
          <button className="text-purple-400 hover:text-purple-300">Chính sách bảo mật</button>
        </p>
      </div>
    </div>
  )
